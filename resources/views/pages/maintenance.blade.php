...
<head>
    ...
    <!-- Custom CSS -->
    <link href="error/css/landing-page.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="error/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <div class="overlay">
        ...
        <div class="container">
            <div class="intro-message">
                <h1 href="/">takween.online</h1>
                <h2>This page is currently down for maintenance.</h2>
                <hr class="intro-divider">
                <h3>In the meantime, you can find us on these social media platforms.</h3>
                <ul class="intro-social-buttons">
                <li>
                        <a href="/" class="btn btn-default btn-lg"><i></i> <span class="network-name">takween.online</span></a>
                    </li>
                    <li>
